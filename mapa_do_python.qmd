...
Para executar alguma função, nós podemos criar códigos ou usar bibliotecas prontas que facilitam a execução de uma tarefa. Essas bibliotecas podem ser mais eficientes do que novos códigos criados permitindo ganho de tempo.
:::
